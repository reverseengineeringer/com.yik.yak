...
public final class ig
{
  ...
  public ig(Context paramContext, Looper paramLooper, ii paramii)
  {
    b = paramii;
    f = new ih(this, paramLooper);
  }
  ...
  {
    iB.a(paramOnConnectionFailedListener);
    synchronized (e)
    {
