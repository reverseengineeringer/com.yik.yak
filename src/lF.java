  ...
  implements ld
{
  ...
  /* Error */
  public hz a(hz paramhz1, hz paramhz2, Bundle paramBundle)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   74: aload_0
    //   75: getfield 15	lf:a	Landroid/os/IBinder;
    //   78: iconst_4
    //   79: aload 5
    //   81: aload 6
    //   83: iconst_0
    ...
    //   100: invokestatic 65	hA:a	(Landroid/os/IBinder;)Lhz;
    //   103: astore_1
    //   104: aload 6
  ...
  public void a(hz paramhz, StreetViewPanoramaOptions paramStreetViewPanoramaOptions, Bundle paramBundle)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    label127:
    for (;;)
    {
      try
      {
        ...
        if (paramhz != null)
        {
          paramhz = paramhz.asBinder();
          localParcel1.writeStrongBinder(paramhz);
