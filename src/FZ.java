  ...
  implements eI
{
  ...
  fz(eJ parameJ, Context paramContext)
  {
    this(parameJ, paramContext, "google_analytics_v2.db");
  }
  
  @VisibleForTesting
  fz(eJ parameJ, Context paramContext, String paramString)
  {
    ...
    h = new fA(this);
    b = new fB(this, e, f);
    c = new fF(new DefaultHttpClient(), e);
    g = 0L;
  }
  ...
  static String a(Map<String, String> paramMap)
  {
    ...
    while (paramMap.hasNext())
    {
      ...
      localArrayList.add(fs.a((String)localEntry.getKey()) + "=" + fs.a((String)localEntry.getValue()));
    }
  ...
  private void a(Map<String, String> paramMap, long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ft.d("Empty path: not sending hit");
        return;
      }
  ...
  private void f()
  {
    ...
    {
      List localList = a(i);
      ft.c("Store full, deleting " + localList.size() + " hits to make room.");
  ...
  List<String> a(int paramInt)
  {
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 295
    //   16: invokestatic 107	ft:d	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 297
    //   26: invokespecial 189	fz:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   182: invokestatic 107	ft:d	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  public void a()
  {
    ...
    do
    {
      ...
      {
        ft.c("...nothing to dispatch");
        d.a(true);
        return;
      }
      i = c.a(localList);
      ft.c("sent " + i + " of " + localList.size() + " hits");
  ...
  @Deprecated
  void a(Collection<fr> paramCollection)
  {
    if ((paramCollection == null) || (paramCollection.isEmpty()))
    {
      ft.d("Empty/Null collection passed to deleteHits.");
      return;
    }
    ...
    while (paramCollection.hasNext())
    {
      arrayOfString[i] = String.valueOf(((fr)paramCollection.next()).b());
      i += 1;
    }
    a(arrayOfString);
  }
  ...
  void a(String[] paramArrayOfString)
  {
    ...
    if ((paramArrayOfString == null) || (paramArrayOfString.length == 0)) {
      ft.d("Empty hitIds passed to deleteHits.");
    }
    Object localObject;
    do
    {
    ...
    for (;;)
    {
      ...
      {
        ft.d("Error deleting hits " + paramArrayOfString);
        return;
      }
      bool = false;
    }
  ...
  public List<fr> b(int paramInt)
  {
    ...
    //   9: aload_0
    //   10: ldc_w 429
    //   13: invokespecial 189	fz:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   133: invokespecial 432	fr:<init>	(Ljava/lang/String;JJ)V
    ...
    //   271: checkcast 390	fr
    //   274: aload 6
    //   276: iconst_1
    //   277: invokeinterface 449 2 0
    //   282: invokevirtual 451	fr:a	(Ljava/lang/String;)V
    //   285: aload 7
    //   287: iload_1
    //   288: invokeinterface 446 2 0
    //   293: checkcast 390	fr
    //   296: aload 6
    //   298: iconst_2
    //   299: invokeinterface 449 2 0
    //   304: invokevirtual 453	fr:b	(Ljava/lang/String;)V
    //   307: aload 6
    ...
    //   371: invokestatic 107	ft:d	(Ljava/lang/String;)V
    //   374: aload 4
    //   376: astore 6
    //   378: aload 5
    //   380: ifnull -353 -> 27
    ...
    //   435: checkcast 390	fr
    //   438: invokevirtual 393	fr:b	()J
    ...
    //   448: invokestatic 107	ft:d	(Ljava/lang/String;)V
    //   451: goto -144 -> 307
    //   454: astore 5
    //   456: aload 6
    //   458: astore 4
    ...
    //   492: invokestatic 107	ft:d	(Ljava/lang/String;)V
    //   495: aload 4
    //   497: astore 5
    ...
    //   548: checkcast 390	fr
    //   551: astore 8
    //   553: aload 4
    //   555: astore 5
    //   557: aload 8
    //   559: invokevirtual 459	fr:a	()Ljava/lang/String;
  ...
  int d()
  {
    ...
    for (;;)
    {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        ft.d("Error getting numStoredHits");
        return 0;
      }
      finally
      {
