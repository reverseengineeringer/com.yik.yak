  ...
  implements Flushable
{
  ...
  private af(OutputStream paramOutputStream, byte[] paramArrayOfByte)
  {
    d = paramOutputStream;
    a = paramArrayOfByte;
    c = 0;
  ...
  public static af a(OutputStream paramOutputStream)
  {
    return a(paramOutputStream, 4096);
  }
  
  public static af a(OutputStream paramOutputStream, int paramInt)
  {
    return new af(paramOutputStream, new byte[paramInt]);
  }
  ...
  public static int b(int paramInt, ab paramab)
  {
    return j(paramInt) + b(paramab);
  }
  ...
  public static int b(ab paramab)
  {
    return l(paramab.a()) + paramab.a();
  }
  ...
  public void a(ab paramab, int paramInt1, int paramInt2)
  {
    if (b - c >= paramInt2)
    {
      paramab.a(a, paramInt1, c, paramInt2);
      c += paramInt2;
      return;
    }
    int j = b - c;
    paramab.a(a, paramInt1, c, j);
    int i = paramInt1 + j;
