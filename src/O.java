...
@TargetApi(14)
public class o
  extends e<SupportMenuItem>
  implements MenuItem
{
  private Method c;
  
  o(Context paramContext, SupportMenuItem paramSupportMenuItem)
  {
    super(paramContext, paramSupportMenuItem);
  }
  
  p a(android.view.ActionProvider paramActionProvider)
  {
  ...
  public android.view.ActionProvider getActionProvider()
  {
    ...
    if ((localActionProvider instanceof p)) {
      return a;
    }
    return null;
  }
  ...
  public MenuItem setActionView(int paramInt)
  {
    ...
    if ((localView instanceof CollapsibleActionView)) {
      ((SupportMenuItem)b).setActionView(new q(localView));
    }
    return this;
  }
