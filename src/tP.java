...
class tp
{
  ...
  /* Error */
  public tp(Context paramContext)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   7: aload_0
    //   8: aload_1
    //   9: putfield 30	tp:a	Landroid/content/Context;
    //   12: aload_0
    //   13: getfield 30	tp:a	Landroid/content/Context;
    //   16: invokevirtual 36	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   19: astore 6
    //   21: aload 6
    //   23: aload_0
    //   24: getfield 30	tp:a	Landroid/content/Context;
    ...
    //   56: aload_0
    //   57: aload_3
    //   58: putfield 63	tp:e	Ljava/lang/String;
    //   61: aload_0
    //   62: aload_1
    //   63: putfield 65	tp:f	Ljava/lang/Integer;
    //   66: aload 6
    ...
    //   134: aload_0
    //   135: aload_1
    //   136: putfield 93	tp:b	Ljava/lang/Boolean;
    //   139: aload_0
    //   140: aload_3
    //   141: putfield 95	tp:c	Ljava/lang/Boolean;
    //   144: aload_0
    //   145: new 97	android/util/DisplayMetrics
    //   148: dup
    //   149: invokespecial 98	android/util/DisplayMetrics:<init>	()V
    //   152: putfield 100	tp:d	Landroid/util/DisplayMetrics;
    //   155: aload_0
    //   156: getfield 30	tp:a	Landroid/content/Context;
    //   159: ldc 102
    ...
    //   172: aload_0
    //   173: getfield 100	tp:d	Landroid/util/DisplayMetrics;
