...
class ag
{
  ...
  public ag(HI paramHI)
  {
    Object localObject = new byte[10];
    a((byte[])localObject);
    b((byte[])localObject);
    c((byte[])localObject);
    paramHI = Hw.a(paramHI.b());
    localObject = Hw.a((byte[])localObject);
    b = String.format(Locale.US, "%s-%s-%s-%s", new Object[] { ((String)localObject).substring(0, 12), ((String)localObject).substring(12, 16), ((String)localObject).subSequence(16, 20), paramHI.substring(0, 12) }).toUpperCase(Locale.US);
  }
