  ...
  implements yM
{
  ...
  zk(JS paramJS, boolean paramBoolean)
  {
    a = paramJS;
    d = paramBoolean;
    paramJS = new Deflater();
    paramJS.setDictionary(zi.a);
    b = new JP();
    c = Ka.a(new JV(b, paramJS));
  }
  
  private void a(List<yN> paramList)
  {
    if (b.c() != 0L) {
  ...
  void a(int paramInt1, int paramInt2, JP paramJP, int paramInt3)
  {
    if (e) {
  ...
  public void a(int paramInt, yJ paramyJ, byte[] paramArrayOfByte)
  {
    try
    {
      if (e) {
  ...
  public void a(boolean paramBoolean, int paramInt1, JP paramJP, int paramInt2)
  {
    if (paramBoolean) {}
    for (int i = 1;; i = 0) {
      try
      {
        a(paramInt1, i, paramJP, paramInt2);
        return;
      }
      finally {}
    }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, List<yN> paramList)
  {
    int j = 0;
    try
    {
