  ...
  implements gr
{
  ...
  ge(gs paramgs, Context paramContext, gM paramgM)
  {
    this(paramgs, paramContext, "google_analytics_v4.db", 2000, paramgM);
  }
  
  ge(gs paramgs, Context paramContext, String paramString, int paramInt, gM paramgM)
  {
    ...
    j = iW.c();
    b = new gf(this, e, f);
    c = new gy(new DefaultHttpClient(), e, k);
    h = 0L;
    i = paramInt;
  }
  ...
  static String a(Map<String, String> paramMap)
  {
    ...
    while (paramMap.hasNext())
    {
      ...
      localArrayList.add(ga.a((String)localEntry.getKey()) + "=" + ga.a((String)localEntry.getValue()));
    }
  ...
  private void a(Map<String, String> paramMap, long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        gc.d("Empty path: not sending hit");
        return;
      }
  ...
  private void f()
  {
    ...
    {
      List localList = a(m);
      gc.c("Store full, deleting " + localList.size() + " hits to make room.");
  ...
  List<String> a(int paramInt)
  {
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 327
    //   16: invokestatic 119	gc:d	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 329
    //   26: invokespecial 201	ge:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   182: invokestatic 119	gc:d	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  @Deprecated
  void a(Collection<fZ> paramCollection)
  {
    if ((paramCollection == null) || (paramCollection.isEmpty()))
    {
      gc.d("Empty/Null collection passed to deleteHits.");
      return;
    }
    ...
    while (paramCollection.hasNext())
    {
      arrayOfString[m] = String.valueOf(((fZ)paramCollection.next()).b());
      m += 1;
    }
    a(arrayOfString);
  }
  ...
  void a(String[] paramArrayOfString)
  {
    ...
    if ((paramArrayOfString == null) || (paramArrayOfString.length == 0)) {
      gc.d("Empty hitIds passed to deleteHits.");
    }
    Object localObject;
    do
    {
    ...
    for (;;)
    {
      ...
      {
        gc.d("Error deleting hits " + TextUtils.join(",", paramArrayOfString));
        return;
      }
      bool = false;
    }
  ...
  int b()
  {
    ...
    for (;;)
    {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        gc.d("Error getting numStoredHits");
        return 0;
      }
      finally
      {
  ...
  public List<fZ> b(int paramInt)
  {
    ...
    //   9: aload_0
    //   10: ldc_w 428
    //   13: invokespecial 201	ge:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   133: ldc_w 430
    //   136: invokespecial 433	fZ:<init>	(Ljava/lang/String;JJLjava/lang/String;)V
    ...
    //   274: checkcast 378	fZ
    //   277: aload 6
    //   279: iconst_1
    //   280: invokeinterface 450 2 0
    //   285: invokevirtual 452	fZ:a	(Ljava/lang/String;)V
    //   288: aload 7
    //   290: iload_1
    //   291: invokeinterface 447 2 0
    //   296: checkcast 378	fZ
    //   299: aload 6
    //   301: iconst_2
    //   302: invokeinterface 450 2 0
    //   307: invokevirtual 454	fZ:b	(Ljava/lang/String;)V
    //   310: aload 6
    ...
    //   374: invokestatic 119	gc:d	(Ljava/lang/String;)V
    //   377: aload 4
    //   379: astore 6
    //   381: aload 5
    //   383: ifnull -356 -> 27
    ...
    //   438: checkcast 378	fZ
    //   441: invokevirtual 380	fZ:b	()J
    ...
    //   451: invokestatic 119	gc:d	(Ljava/lang/String;)V
    //   454: goto -144 -> 310
    //   457: astore 5
    //   459: aload 6
    //   461: astore 4
    ...
    //   495: invokestatic 119	gc:d	(Ljava/lang/String;)V
    //   498: aload 4
    //   500: astore 5
    ...
    //   551: checkcast 378	fZ
    //   554: astore 8
    //   556: aload 4
    //   558: astore 5
    //   560: aload 8
    //   562: invokevirtual 460	fZ:a	()Ljava/lang/String;
  ...
  public void c()
  {
    ...
    {
      gc.c("...nothing to dispatch");
      d.a(true);
      return;
    }
    if (g == null) {
      g = new gd("_t=dispatch&_v=ma4.0.4", false);
    }
    if (b() <= localList.size()) {}
    for (;;)
    {
      int m = c.a(localList, g, bool);
      gc.c("sent " + m + " of " + localList.size() + " hits");
