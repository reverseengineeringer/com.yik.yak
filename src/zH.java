...
class zh
{
  ...
  {
    zi localzi2 = new zi(paramInt1, paramByte);
    for (zi localzi1 = d; paramByte > 8; localzi1 = zi.a(localzi1)[paramInt1])
    {
      paramByte = (byte)(paramByte - 8);
      paramInt1 = paramInt2 >>> paramByte & 0xFF;
      if (zi.a(localzi1) == null) {
        throw new IllegalStateException("invalid dictionary: prefix not unique");
      }
      if (zi.a(localzi1)[paramInt1] == null) {
        zi.a(localzi1)[paramInt1] = new zi();
      }
    }
    ...
    {
      zi.a(localzi1)[paramInt1] = localzi2;
      paramInt1 += 1;
    }
  }
  ...
  byte[] a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (i >= 8)
      {
        localzi1 = zi.a(localzi1)[(k >>> i - 8 & 0xFF)];
        if (zi.a(localzi1) == null)
        {
          localByteArrayOutputStream.write(zi.b(localzi1));
          i -= zi.c(localzi1);
          localzi1 = d;
        }
        else
    ...
    do
    {
      localByteArrayOutputStream.write(zi.b(paramArrayOfByte));
      m -= zi.c(paramArrayOfByte);
      localzi2 = d;
      if (m <= 0) {
        break;
      }
      paramArrayOfByte = zi.a(localzi2)[(k << 8 - m & 0xFF)];
    } while ((zi.a(paramArrayOfByte) == null) && (zi.c(paramArrayOfByte) <= m));
