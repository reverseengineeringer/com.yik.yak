...
class qM<K extends Comparable<K>, V>
  extends AbstractMap<K, V>
{
  private final int a;
  private List<qM<K, V>.qR> b;
  private Map<K, V> c;
  private boolean d;
  private volatile qM<K, V>.qT e;
  
  private qM(int paramInt)
  {
    a = paramInt;
  ...
  private int a(K paramK)
  {
    ...
    if (m >= 0)
    {
      int n = paramK.compareTo(((qR)b.get(m)).a());
      if (n > 0) {
        return -(m + 2);
      }
      i = m;
    ...
    {
      k = (j + i) / 2;
      m = paramK.compareTo(((qR)b.get(k)).a());
      if (m < 0) {
        i = k - 1;
      }
      for (;;)
  ...
  static <FieldDescriptorType extends qh<FieldDescriptorType>> qM<FieldDescriptorType, Object> a(int paramInt)
  {
    return new qN(paramInt);
  }
  
  private V c(int paramInt)
  {
    e();
    Object localObject = ((qR)b.remove(paramInt)).getValue();
    if (!c.isEmpty())
    {
      Iterator localIterator = f().entrySet().iterator();
      b.add(new qR(this, (Map.Entry)localIterator.next()));
  ...
  public V a(K paramK, V paramV)
  {
    ...
    int i = a(paramK);
    if (i >= 0) {
      return (V)((qR)b.get(i)).setValue(paramV);
    }
    g();
    i = -(i + 1);
    if (i >= a) {
    ...
    if (b.size() == a)
    {
      qR localqR = (qR)b.remove(a - 1);
      f().put(localqR.a(), localqR.getValue());
    }
    b.add(i, new qR(this, paramK, paramV));
    return null;
  }
