...
{
  pn(pk parampk, Context paramContext, String paramString)
  {
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   73: invokestatic 101	os:b	(Ljava/lang/String;)V
    //   76: aload_2
    //   77: ifnull +9 -> 86
    //   80: aload_2
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    ...
    catch (SQLiteException localSQLiteException)
    {
      ...
      {
        Object localObject2;
        pk.b(a).getDatabasePath("google_tagmanager.db").delete();
      }
    }
  ...
  {
    on.a(paramSQLiteDatabase.getPath());
  }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      {
        paramSQLiteDatabase.execSQL(pk.a());
        return;
      }
    }
    finally
