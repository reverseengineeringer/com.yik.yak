  ...
  implements ne
{
  ...
  /* Error */
  public hw a(android.graphics.Bitmap paramBitmap)
  {
    // Byte code:
    ...
    //   52: invokestatic 47	hx:a	(Landroid/os/IBinder;)Lhw;
    //   55: astore_1
    //   56: aload_3
  ...
  public hw a(String paramString)
  {
    ...
    try
    {
      ...
      localParcel2.readException();
      paramString = hx.a(localParcel2.readStrongBinder());
      return paramString;
    }
    finally
    {
  ...
  public hw c(String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    try
