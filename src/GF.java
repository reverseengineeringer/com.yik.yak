  ...
  extends SQLiteOpenHelper
{
  ...
  gf(ge paramge, Context paramContext, String paramString)
  {
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   73: invokestatic 114	gc:d	(Ljava/lang/String;)V
    //   76: aload_2
    //   77: ifnull +9 -> 86
    //   80: aload_2
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    ...
    catch (SQLiteException localSQLiteException)
    {
      ...
      {
        Object localObject2;
        ge.c(a).getDatabasePath(ge.b(a)).delete();
      }
    }
  ...
  {
    gR.a(paramSQLiteDatabase.getPath());
  }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      {
        paramSQLiteDatabase.execSQL(ge.e());
        return;
      }
    }
    finally
