...
public abstract class mb
  ...
  implements ma
{
  public static ma a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof ma))) {
      return (ma)localIInterface;
    }
    return new mc(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    boolean bool = a(no.a(paramParcel1.readStrongBinder()));
