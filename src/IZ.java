  ...
  implements ix
{
  ...
  iz(IBinder paramIBinder)
  {
    a = paramIBinder;
  }
  
  /* Error */
  public hz a(hz paramhz, int paramInt1, int paramInt2)
  {
    // Byte code:
    ...
    //   46: aload_0
    //   47: getfield 15	iz:a	Landroid/os/IBinder;
    //   50: iconst_1
    //   51: aload 4
    //   53: aload 5
    //   55: iconst_0
    ...
    //   72: invokestatic 59	hA:a	(Landroid/os/IBinder;)Lhz;
    //   75: astore_1
    //   76: aload 5
