  ...
  implements zM
{
  ...
  {
    return new zt(paramKB, paramBoolean);
  }
  
  public yW a(KA paramKA, boolean paramBoolean)
  {
    return new zu(paramKA, paramBoolean);
  }
}
