  ...
  implements ob
{
  ...
  public pk(Context paramContext)
  {
    this(paramContext, iW.c(), "google_tagmanager.db", 2000, Executors.newSingleThreadExecutor());
  }
  
  pk(Context paramContext, iV paramiV, String paramString, int paramInt, Executor paramExecutor)
  {
    c = paramContext;
    e = paramiV;
    f = paramInt;
    b = paramExecutor;
    d = new pn(this, c, paramString);
  }
  ...
  {
    // Byte code:
    //   0: new 95	java/io/ByteArrayInputStream
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 98	java/io/ByteArrayInputStream:<init>	([B)V
    //   8: astore_3
    //   9: new 100	java/io/ObjectInputStream
    //   12: dup
    //   13: aload_3
    //   14: invokespecial 103	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   17: astore_1
    //   18: aload_1
    //   19: invokevirtual 107	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   22: astore_2
    //   23: aload_1
    //   24: ifnull +7 -> 31
    //   27: aload_1
    //   28: invokevirtual 110	java/io/ObjectInputStream:close	()V
    //   31: aload_3
    //   32: invokevirtual 111	java/io/ByteArrayInputStream:close	()V
    //   35: aload_2
    //   36: areturn
    //   37: astore_1
    //   38: aconst_null
    ...
    //   41: ifnull +7 -> 48
    //   44: aload_1
    //   45: invokevirtual 110	java/io/ObjectInputStream:close	()V
    //   48: aload_3
    //   49: invokevirtual 111	java/io/ByteArrayInputStream:close	()V
    //   52: aconst_null
    //   53: areturn
    //   54: astore_1
    //   55: aconst_null
    ...
    //   61: ifnull +7 -> 68
    //   64: aload_1
    //   65: invokevirtual 110	java/io/ObjectInputStream:close	()V
    //   68: aload_3
    //   69: invokevirtual 111	java/io/ByteArrayInputStream:close	()V
    //   72: aconst_null
    //   73: areturn
    //   74: astore_1
    //   75: aconst_null
    ...
    //   81: ifnull +7 -> 88
    //   84: aload_1
    //   85: invokevirtual 110	java/io/ObjectInputStream:close	()V
    //   88: aload_3
    //   89: invokevirtual 111	java/io/ByteArrayInputStream:close	()V
    //   92: aload_2
    //   93: athrow
    //   94: astore_1
    //   95: goto -3 -> 92
  ...
  private List<nZ> a(List<po> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      po localpo = (po)paramList.next();
      localArrayList.add(new nZ(a, a(b)));
    }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt > 0)
    {
      ...
      os.c("DataLayer store full, deleting " + localList.size() + " entries to make room.");
  ...
  private void a(long paramLong)
  {
    ...
    try
    {
      ...
      os.d("Deleted " + i + " expired items");
      return;
    }
    catch (SQLiteException localSQLiteException)
    {
      os.b("Error deleting old entries.");
    }
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    {
      os.b("Error deleting entries " + Arrays.toString(paramArrayOfString));
    }
  }
  ...
  private byte[] a(Object paramObject)
  {
    ...
    //   7: astore_3
    //   8: new 255	java/io/ObjectOutputStream
    //   11: dup
    //   12: aload_3
    //   13: invokespecial 258	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   16: astore_2
    //   17: aload_2
    //   18: aload_1
    //   19: invokevirtual 262	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   22: aload_3
    //   23: invokevirtual 266	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   26: astore_1
    //   27: aload_2
    //   28: ifnull +7 -> 35
    //   31: aload_2
    //   32: invokevirtual 267	java/io/ObjectOutputStream:close	()V
    //   35: aload_3
    //   36: invokevirtual 268	java/io/ByteArrayOutputStream:close	()V
    //   39: aload_1
    //   40: areturn
    //   41: astore_1
    //   42: aconst_null
    ...
    //   45: ifnull +7 -> 52
    //   48: aload_2
    //   49: invokevirtual 267	java/io/ObjectOutputStream:close	()V
    //   52: aload_3
    //   53: invokevirtual 268	java/io/ByteArrayOutputStream:close	()V
    //   56: aconst_null
    //   57: areturn
    //   58: astore_1
    //   59: aconst_null
    ...
    //   65: ifnull +7 -> 72
    //   68: aload_2
    //   69: invokevirtual 267	java/io/ObjectOutputStream:close	()V
    //   72: aload_3
    //   73: invokevirtual 268	java/io/ByteArrayOutputStream:close	()V
    //   76: aload_1
    //   77: athrow
    //   78: astore_2
    //   79: goto -3 -> 76
  ...
  private List<String> b(int paramInt)
  {
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 285
    //   16: invokestatic 88	os:b	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 287
    //   26: invokespecial 197	pk:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   52: astore 4
    //   54: iload_1
    //   55: invokestatic 294	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   58: astore 5
    //   60: aload_3
    //   61: ldc 24
    //   63: iconst_1
    ...
    //   76: aload 4
    //   78: aload 5
    //   80: invokevirtual 298	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore_3
    //   88: aload 4
    ...
    //   111: invokestatic 310	java/lang/String:valueOf	(J)Ljava/lang/String;
    ...
    //   171: aload 5
    //   173: invokevirtual 319	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   176: invokevirtual 170	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 181	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 88	os:b	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  private List<po> b(List<nZ> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      nZ localnZ = (nZ)paramList.next();
      localArrayList.add(new po(a, a(b)));
    }
    return localArrayList;
  }
  
  /* Error */
  private void b(List<po> paramList, long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	pk:e	LiV;
    //   6: invokeinterface 274 1 0
    //   11: lstore 4
    //   13: aload_0
    //   14: lload 4
    //   16: invokespecial 276	pk:a	(J)V
    //   19: aload_0
    //   20: aload_1
    //   21: invokeinterface 173 1 0
    //   26: invokespecial 332	pk:a	(I)V
    //   29: aload_0
    //   30: aload_1
    //   31: lload 4
    //   33: lload_2
    //   34: ladd
    //   35: invokespecial 334	pk:c	(Ljava/util/List;J)V
    //   38: aload_0
    //   39: invokespecial 282	pk:e	()V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: astore_1
    //   46: aload_0
    //   47: invokespecial 282	pk:e	()V
    //   50: aload_1
    //   51: athrow
    //   52: astore_1
    //   53: aload_0
  ...
  private List<po> c()
  {
    Object localObject = a("Error opening database for loadSerialized.");
    ArrayList localArrayList = new ArrayList();
    if (localObject == null) {
      return localArrayList;
    }
    ...
    try
    {
      if (((Cursor)localObject).moveToNext()) {
        localArrayList.add(new po(((Cursor)localObject).getString(0), ((Cursor)localObject).getBlob(1)));
      }
      return localList;
    }
    finally
  ...
  private void c(List<po> paramList, long paramLong)
  {
  ...
  private int d()
  {
    ...
    int i = 0;
    int j = 0;
    Object localObject5 = a("Error opening database for getNumStoredEntries.");
    ...
    for (;;)
    {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        os.b("Error getting numStoredEntries");
        return 0;
      }
      finally
      {
  ...
  public void a(List<nZ> paramList, long paramLong)
  {
    paramList = b(paramList);
    b.execute(new pl(this, paramList, paramLong));
  }
  
  public void a(oc paramoc)
  {
    b.execute(new pm(this, paramoc));
  }
}
