...
{
  pk(ph paramph, Context paramContext, String paramString)
  {
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   73: invokestatic 101	op:b	(Ljava/lang/String;)V
    //   76: aload_2
    //   77: ifnull +9 -> 86
    //   80: aload_2
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    ...
    catch (SQLiteException localSQLiteException)
    {
      ...
      {
        Object localObject2;
        ph.b(a).getDatabasePath("google_tagmanager.db").delete();
      }
    }
  ...
  {
    ok.a(paramSQLiteDatabase.getPath());
  }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      {
        paramSQLiteDatabase.execSQL(ph.a());
        return;
      }
    }
    finally
