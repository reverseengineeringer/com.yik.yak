  ...
  extends SQLiteOpenHelper
{
  ...
  gi(gh paramgh, Context paramContext, String paramString)
  {
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   73: invokestatic 114	gf:d	(Ljava/lang/String;)V
    //   76: aload_2
    //   77: ifnull +9 -> 86
    //   80: aload_2
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    ...
    catch (SQLiteException localSQLiteException)
    {
      ...
      {
        Object localObject2;
        gh.c(a).getDatabasePath(gh.b(a)).delete();
      }
    }
  ...
  {
    gU.a(paramSQLiteDatabase.getPath());
  }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      {
        paramSQLiteDatabase.execSQL(gh.e());
        return;
      }
    }
    finally
