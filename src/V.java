...
public class v
  implements View.OnKeyListener, ViewTreeObserver.OnGlobalLayoutListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener, x
{
  ...
  public boolean onSubMenuSelected(D paramD)
  {
    ...
    {
      localv = new v(mContext, paramD, mAnchorView);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (localv.tryShow())
      {
        if (mPresenterCallback != null) {
          mPresenterCallback.onOpenSubMenu(paramD);
        }
        return true;
        i += 1;
        break;
