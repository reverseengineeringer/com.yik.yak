...
public class InsightsLogger
{
  ...
  {
    appEventsLogger = AppEventsLogger.newLogger(paramContext, paramString, paramSession);
  }
  ...
  public void logConversionPixel(String paramString, double paramDouble)
  {
    ...
    appEventsLogger.logEvent("fb_log_offsite_pixel", paramDouble, localBundle);
  ...
  {
    appEventsLogger.logPurchase(paramBigDecimal, paramCurrency, paramBundle);
  }
}
