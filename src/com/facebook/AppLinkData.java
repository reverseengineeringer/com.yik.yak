  ...
  private static void fetchDeferredAppLinkFromServer(Context paramContext, String paramString, AppLinkData.CompletionHandler paramCompletionHandler)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramContext = (Context)localObject1;
          argumentBundle.putString("com.facebook.platform.APPLINK_NATIVE_CLASS", str1);
        }
      }
      catch (JSONException paramContext)
      {
      ...
      try
      {
        ...
        {
          paramContext = (Context)localObject1;
          arguments.put("com.facebook.platform.APPLINK_NATIVE_URL", str2);
        }
        paramString = (String)localObject1;
        paramContext = (Context)localObject1;
        if (argumentBundle != null)
        {
          paramContext = (Context)localObject1;
          argumentBundle.putString("com.facebook.platform.APPLINK_NATIVE_URL", str2);
          paramString = (String)localObject1;
        }
      }
      catch (JSONException paramContext)
