  ...
  extends Session
{
  ...
  private void deleteTestAccount(String paramString1, String paramString2)
  {
    ...
    if (paramString2 != null) {
      String.format("Could not delete test account %s: %s", new Object[] { paramString1, paramString2.getException().toString() });
    }
  ...
  private static TestSession.TestAccount findTestAccountMatchingIdentifier(String paramString)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 258	com/facebook/TestSession:retrieveTestAccountsForAppIfNeeded	()V
    //   6: getstatic 260	com/facebook/TestSession:appTestAccounts	Ljava/util/Map;
    ...
    //   38: astore_2
    //   39: aload_2
    //   40: invokeinterface 284 1 0
    //   45: aload_0
    //   46: invokevirtual 288	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   49: istore_1
    //   50: iload_1
    //   51: ifeq -31 -> 20
    //   54: aload_2
  ...
  private String getSharedTestAccountIdentifier()
  {
    ...
    for (long l1 = sessionUniqueUserTag.hashCode() & 0xFFFFFFFF;; l1 = 0L) {
  ...
  {
    if (mode == TestSession.Mode.PRIVATE)
    {
      createTestAccountAndFinishAuth();
      return;
    }
  ...
  {
    String str = testAccountId;
    super.postStateChange(paramSessionState1, paramSessionState2, paramException);
    if ((paramSessionState2.isClosed()) && (str != null) && (mode == TestSession.Mode.PRIVATE)) {
  ...
  public final String toString()
  {
    ...
    return "{TestSession" + " testUserId:" + testAccountId + " " + str + "}";
  }
}
