...
class AppEventsLogger$PersistedEvents
{
  ...
  private void readAndClearStore()
  {
    ...
    //   94: aload_3
    //   95: invokevirtual 155	java/lang/Exception:toString	()Ljava/lang/String;
    //   98: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   71	24	3	localException1	Exception
  ...
  {
    // Byte code:
    //   0: new 158	java/io/ObjectOutputStream
    //   3: dup
    //   4: new 160	java/io/BufferedOutputStream
    //   7: dup
    //   8: aload_0
    //   9: getfield 31	com/facebook/AppEventsLogger$PersistedEvents:context	Landroid/content/Context;
    //   12: ldc 8
    //   14: iconst_0
    //   15: invokevirtual 164	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   18: invokespecial 167	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   21: invokespecial 168	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   24: astore_2
    //   25: aload_2
    //   26: astore_1
    //   27: aload_2
    ...
    //   32: invokevirtual 172	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   35: aload_2
    ...
    //   63: aload_3
    //   64: invokevirtual 155	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   40	24	3	localException1	Exception
