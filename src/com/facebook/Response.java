...
public class Response
{
  ...
  public final <T extends GraphObject> GraphObjectList<T> getGraphObjectListAs(Class<T> paramClass)
  {
    ...
    return graphObjectList.castToListOf(paramClass);
  }
  ...
  public Request getRequestForPagedResults(Response.PagingDirection paramPagingDirection)
  {
    ...
    if (graphObject != null)
    {
      localPagingInfo = ((Response.PagedResults)graphObject.cast(Response.PagedResults.class)).getPaging();
    ...
    for (;;)
    {
      ...
      while ((paramPagingDirection != null) && (paramPagingDirection.equals(request.getUrlForSingleRequest())))
      {
        return null;
      ...
      try
      {
        paramPagingDirection = new Request(request.getSession(), new URL(paramPagingDirection));
