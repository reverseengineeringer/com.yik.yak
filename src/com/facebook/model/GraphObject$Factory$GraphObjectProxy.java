  ...
  extends GraphObject.Factory.ProxyBase<JSONObject>
{
  ...
  private final Object proxyGraphObjectGettersAndSetters(Method paramMethod, Object[] paramArrayOfObject)
  {
    ...
    if (localPropertyName != null)
    {
      ...
      paramArrayOfObject = ((JSONObject)state).opt((String)localObject);
    ...
    for (paramMethod = (ParameterizedType)paramMethod;; paramMethod = null)
    {
      ...
      if (i == 1)
      {
        ...
        ((JSONObject)state).putOpt((String)localObject, paramMethod);
        return null;
      }
  ...
  private final Object proxyGraphObjectMethods(Object paramObject, Method paramMethod, Object[] paramArrayOfObject)
  {
    ...
    if (str.equals("cast"))
    {
      ...
      return GraphObject.Factory.access$000(paramMethod, (JSONObject)state);
    }
    if (str.equals("getInnerJSONObject")) {
      return getInvocationHandlerstate;
    }
    if (str.equals("asMap")) {
      return GraphObject.Factory.access$100((JSONObject)state);
    }
    ...
    if (str.equals("getPropertyAsList")) {
      return GraphObject.Factory.coerceValueToExpectedType(((JSONObject)state).opt((String)paramArrayOfObject[0]), GraphObjectList.class, new GraphObject.Factory.GraphObjectProxy.1(this, (Class)paramArrayOfObject[1]));
    }
