...
class AppEventsLogger$PersistedAppSessionInfo
{
  ...
  private static void restoreAppSessionInformation(Context paramContext)
  {
    ...
    //   163: aload 4
    //   165: invokevirtual 155	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   139	25	4	localException1	Exception
  ...
  static void saveAppSessionInformation(Context paramContext)
  {
    ...
    //   12: iload_1
    //   13: ifeq +56 -> 69
    //   16: new 159	java/io/ObjectOutputStream
    //   19: dup
    //   20: new 161	java/io/BufferedOutputStream
    //   23: dup
    //   24: aload_0
    //   25: ldc 8
    //   27: iconst_0
    //   28: invokevirtual 165	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   31: invokespecial 168	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   34: invokespecial 169	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   37: astore_2
    //   38: aload_2
    //   39: astore_0
    //   40: aload_2
    //   41: getstatic 43	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   44: invokevirtual 173	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   47: aload_2
    //   48: astore_0
    //   49: iconst_0
    ...
    //   82: aload_2
    //   83: astore_0
    //   84: new 145	java/lang/StringBuilder
    //   87: dup
    ...
    //   96: aload_3
    //   97: invokevirtual 155	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   73	24	3	localException1	Exception
