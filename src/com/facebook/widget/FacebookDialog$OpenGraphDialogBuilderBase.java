  ...
  extends FacebookDialog.Builder<CONCRETE>
{
  ...
  public FacebookDialog$OpenGraphDialogBuilderBase(Activity paramActivity, OpenGraphAction paramOpenGraphAction, String paramString)
  {
    ...
    action = paramOpenGraphAction;
    actionType = paramOpenGraphAction.getType();
  ...
  public FacebookDialog$OpenGraphDialogBuilderBase(Activity paramActivity, OpenGraphAction paramOpenGraphAction, String paramString1, String paramString2)
  {
    ...
    action = paramOpenGraphAction;
    actionType = paramString1;
    previewPropertyName = paramString2;
  }
  ...
  {
    Object localObject = action.getImage();
    if (localObject == null) {
    ...
    for (;;)
    {
      ...
      action.setImage((List)localObject);
      return;
    }
  }
  ...
  protected Bundle getMethodArguments()
  {
    ...
    putExtra(localBundle, "PREVIEW_PROPERTY_NAME", previewPropertyName);
    putExtra(localBundle, "ACTION_TYPE", actionType);
    localBundle.putBoolean("DATA_FAILURES_FATAL", dataErrorsFatal);
    putExtra(localBundle, "ACTION", flattenChildrenOfGraphObject(action.getInnerJSONObject()).toString());
    return localBundle;
  }
  
  protected Bundle setBundleExtras(Bundle paramBundle)
  {
    putExtra(paramBundle, "com.facebook.platform.extra.PREVIEW_PROPERTY_NAME", previewPropertyName);
    putExtra(paramBundle, "com.facebook.platform.extra.ACTION_TYPE", actionType);
    paramBundle.putBoolean("com.facebook.platform.extra.DATA_FAILURES_FATAL", dataErrorsFatal);
    putExtra(paramBundle, "com.facebook.platform.extra.ACTION", flattenChildrenOfGraphObject(action.getInnerJSONObject()).toString());
    return paramBundle;
  }
  ...
  void updateObjectAttachmentUrls(String paramString, List<String> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      localOpenGraphObject = (OpenGraphObject)action.getPropertyAs(paramString, OpenGraphObject.class);
