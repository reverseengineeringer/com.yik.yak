  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      {
        if (!Utility.areObjectsEqual(LikeView.access$600(this$0), str)) {
          break label62;
        }
        i = j;
      }
    ...
    do
    {
      ...
      LikeView.access$800(this$0).onError(paramIntent);
      return;
    } while (!"com.facebook.sdk.LikeActionController.DID_RESET".equals(paramContext));
    LikeView.access$900(this$0, LikeView.access$600(this$0));
    LikeView.access$700(this$0);
  }
}
