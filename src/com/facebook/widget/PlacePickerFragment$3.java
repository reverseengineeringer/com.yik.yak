  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    catch (FacebookException localFacebookException1)
    {
      ...
      localOnErrorListener2 = this$0.getOnErrorListener();
      if (localOnErrorListener2 == null) {
        break label84;
      }
      localOnErrorListener2.onError(this$0, localFacebookException1);
      return;
    ...
    catch (Exception localException)
    {
      ...
      localOnErrorListener2.onError(this$0, localFacebookException2);
      return;
      label141:
    ...
    finally
    {
      ...
      localOnErrorListener2.onError(this$0, null);
    }
