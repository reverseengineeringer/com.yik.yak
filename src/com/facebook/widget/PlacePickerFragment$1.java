  ...
  extends PickerFragment<GraphPlace>.PickerFragmentAdapter<GraphPlace>
{
  ...
  protected CharSequence getSubTitleOfGraphObject(GraphPlace paramGraphPlace)
  {
    ...
    if ((str != null) && (paramGraphPlace != null)) {
      return this$0.getString(R.string.com_facebook_placepicker_subtitle_format, new Object[] { str, paramGraphPlace });
    }
    if ((str == null) && (paramGraphPlace != null)) {
      return this$0.getString(R.string.com_facebook_placepicker_subtitle_were_here_only_format, new Object[] { paramGraphPlace });
    }
    if ((str != null) && (paramGraphPlace == null)) {
      return this$0.getString(R.string.com_facebook_placepicker_subtitle_catetory_only_format, new Object[] { str });
    }
    return null;
  }
}
