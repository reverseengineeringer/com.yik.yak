  ...
  extends PickerFragment<GraphUser>
{
  ...
  {
    paramString = Request.newGraphPathRequest(paramSession, paramString + friendPickerType.getRequestPath(), null);
    paramSet = new HashSet(paramSet);
    paramSet.addAll(Arrays.asList(new String[] { "id", "name" }));
    paramSession = adapter.getPictureFieldSpecifier();
  ...
  private void setFriendPickerSettingsFromBundle(Bundle paramBundle)
  {
    if (paramBundle != null)
    {
      ...
      setMultiSelect(paramBundle.getBoolean("com.facebook.widget.FriendPickerFragment.MultiSelect", multiSelect));
      if (!paramBundle.containsKey("com.facebook.widget.FriendPickerFragment.FriendPickerType")) {}
    }
    try
    {
      friendPickerType = FriendPickerFragment.FriendPickerType.valueOf(paramBundle.getString("com.facebook.widget.FriendPickerFragment.FriendPickerType"));
      return;
    }
  ...
  Request getRequestForLoadData(Session paramSession)
  {
    ...
    if (userId != null) {}
    for (String str = userId;; str = "me") {
      return createRequest(str, extraFields, paramSession);
    }
  }
  ...
  public void onInflate(Activity paramActivity, AttributeSet paramAttributeSet, Bundle paramBundle)
  {
    ...
    setMultiSelect(paramActivity.getBoolean(R.styleable.com_facebook_friend_picker_fragment_multi_select, multiSelect));
  ...
  void saveSettingsToBundle(Bundle paramBundle)
  {
    ...
    paramBundle.putString("com.facebook.widget.FriendPickerFragment.UserId", userId);
    paramBundle.putBoolean("com.facebook.widget.FriendPickerFragment.MultiSelect", multiSelect);
  }
  
  public void setFriendPickerType(FriendPickerFragment.FriendPickerType paramFriendPickerType)
  {
    friendPickerType = paramFriendPickerType;
  }
  
  public void setMultiSelect(boolean paramBoolean)
  {
    if (multiSelect != paramBoolean)
    {
      multiSelect = paramBoolean;
  ...
  {
    preSelectedFriendIds.addAll(paramList);
  }
