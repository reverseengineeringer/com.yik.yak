  ...
  implements Serializable
{
  ...
  public static final Session restoreSession(Context paramContext, TokenCachingStrategy paramTokenCachingStrategy, Session.StatusCallback paramStatusCallback, Bundle paramBundle)
  {
    ...
    if (localObject != null)
    {
      ...
      try
      {
        ...
        initializeStaticContext(paramContext);
        if (paramTokenCachingStrategy != null) {}
        for (tokenCachingStrategy = paramTokenCachingStrategy;; tokenCachingStrategy = new SharedPreferencesTokenCachingStrategy(paramContext))
        {
      ...
      catch (IOException paramContext) {}catch (ClassNotFoundException paramContext) {}
    }
  }
  ...
  void finishAuthOrReauth(AccessToken arg1, Exception paramException)
  {
    ...
    for (;;)
    {
      ...
      continue;
      new StringBuilder().append("Unexpected call to finishAuthOrReauth in state ").append(state).toString();
    }
  }
