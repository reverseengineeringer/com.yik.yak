  ...
  implements BinaryDecoder, BinaryEncoder
{
  ...
  public Object decode(Object paramObject)
  {
    ...
    //   14: astore_1
    //   15: aload_1
    //   16: invokestatic 116	com/parse/codec/binary/Hex:decodeHex	([C)[B
    //   19: areturn
    //   20: aload_1
    //   21: checkcast 117	[C
    //   24: checkcast 117	[C
    ...
    //   28: goto -13 -> 15
    //   31: astore_1
    //   32: new 55	com/parse/codec/DecoderException
    //   35: dup
    //   36: aload_1
    //   37: invokevirtual 120	java/lang/ClassCastException:getMessage	()Ljava/lang/String;
    //   40: aload_1
    //   41: invokespecial 123	com/parse/codec/DecoderException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   44: athrow
  ...
  public Object encode(Object paramObject)
  {
    ...
    //   8: checkcast 75	java/lang/String
    //   11: aload_0
    //   12: invokevirtual 129	com/parse/codec/binary/Hex:getCharsetName	()Ljava/lang/String;
    //   15: invokevirtual 138	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   18: astore_1
    //   19: aload_1
    //   20: invokestatic 77	com/parse/codec/binary/Hex:encodeHex	([B)[C
    //   23: areturn
    //   24: aload_1
    //   25: checkcast 140	[B
    //   28: checkcast 140	[B
    ...
    //   32: goto -13 -> 19
    //   35: astore_1
    //   36: new 142	com/parse/codec/EncoderException
    //   39: dup
    //   40: aload_1
    //   41: invokevirtual 120	java/lang/ClassCastException:getMessage	()Ljava/lang/String;
    //   44: aload_1
    //   45: invokespecial 143	com/parse/codec/EncoderException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   48: athrow
    //   49: astore_1
    //   50: new 142	com/parse/codec/EncoderException
    //   53: dup
    //   54: aload_1
    //   55: invokevirtual 133	java/io/UnsupportedEncodingException:getMessage	()Ljava/lang/String;
    //   58: aload_1
    //   59: invokespecial 143	com/parse/codec/EncoderException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   62: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	63	0	this	Hex
