...
class TaskQueue
{
  ...
  private R<Void> getTaskToAwait()
  {
    ...
    //   9: aload_0
    //   10: getfield 27	com/parse/TaskQueue:tail	LR;
    //   13: ifnull +32 -> 45
    //   16: aload_0
    //   17: getfield 27	com/parse/TaskQueue:tail	LR;
    //   20: astore_1
    //   21: aload_1
    ...
    //   44: areturn
    //   45: aconst_null
    //   46: invokestatic 44	R:a	(Ljava/lang/Object;)LR;
    //   49: astore_1
    //   50: goto -29 -> 21
    //   53: astore_1
    //   54: aload_0
  ...
  static <T> Q<T, R<T>> waitFor(R<Void> paramR)
  {
    return new TaskQueue.2(paramR);
  }
  
  /* Error */
  <T> R<T> enqueue(Q<Void, R<T>> paramQ)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 18	com/parse/TaskQueue:lock	Ljava/util/concurrent/locks/Lock;
    ...
    //   21: aload_1
    //   22: aload_0
    //   23: invokespecial 61	com/parse/TaskQueue:getTaskToAwait	()LR;
    ...
    //   51: invokestatic 76	R:a	(Ljava/util/Collection;)LR;
    //   54: putfield 27	com/parse/TaskQueue:tail	LR;
    //   57: aload_0
    ...
    //   67: areturn
    //   68: aconst_null
    //   69: invokestatic 44	R:a	(Ljava/lang/Object;)LR;
    //   72: astore_2
    //   73: goto -52 -> 21
    //   76: astore_1
    //   77: aload_1
