...
class ParseObject$37$2$3$1$1$1
  implements Q<JSONArray, R<Void>>
{
  ParseObject$37$2$3$1$1$1(ParseObject.37.2.3.1.1 param1) {}
  
  public R<Void> then(R<JSONArray> paramR)
  {
    ArrayList localArrayList = new ArrayList();
    int i = 0;
    while (i < this$4.this$3.this$2.val$current.size())
    {
      JSONObject localJSONObject = ((JSONArray)paramR.e()).getJSONObject(i);
    ...
    return R.a(localArrayList).b(new ParseObject.37.2.3.1.1.1.1(this, localArrayList));
  }
}
