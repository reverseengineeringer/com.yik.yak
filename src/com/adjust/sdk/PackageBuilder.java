...
public class PackageBuilder
{
  ...
  private void fillPluginKeys(Map<String, String> paramMap)
  {
    ...
    {
      return;
      Iterator localIterator = pluginsKeys.entrySet().iterator();
  ...
  private Map<String, String> getDefaultParameters()
  {
    ...
    addString(localHashMap, "gps_adid", Util.getPlayAdId(context));
    addBoolean(localHashMap, "tracking_enabled", Util.isPlayTrackingEnabled(context));
  ...
  private boolean isEventTokenValid()
  {
    ...
    {
      AdjustFactory.getLogger().error("Malformed Event Token '%s'", new Object[] { eventToken });
      return false;
    }
    return true;
  }
  ...
  public boolean isValidForRevenue()
  {
    ...
    {
      AdjustFactory.getLogger().error("Invalid amount %f", new Object[] { Double.valueOf(amountInCents) });
      return false;
    }
    if (eventToken == null) {
      return true;
