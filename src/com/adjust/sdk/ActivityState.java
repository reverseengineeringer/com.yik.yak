  ...
  private void readObject(ObjectInputStream paramObjectInputStream)
  {
    ...
    try
    {
      ...
      if (uuid == null)
      {
        ...
        new StringBuilder().append("migrate ").append(uuid).toString();
      }
      return;
    }
    catch (Exception paramObjectInputStream)
    {
      for (;;)
      {
        AdjustFactory.getLogger().debug("Unable to read new field in migration device with error (%s)", new Object[] { paramObjectInputStream.getMessage() });
      }
    }
  }
