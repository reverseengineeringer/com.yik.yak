...
public class a
{
  ...
  public static int G(Parcel paramParcel)
  {
    ...
    int i = paramParcel.dataPosition();
    if (aH(j) != 20293) {
      throw new a.a("Expected object header. Got 0x" + Integer.toHexString(j), paramParcel);
    }
    j = i + k;
    if ((j < i) || (j > paramParcel.dataSize())) {
      throw new a.a("Size read is invalid start=" + i + " end=" + j, paramParcel);
    }
    return j;
  }
  ...
  private static void a(Parcel paramParcel, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 != paramInt2) {
      throw new a.a("Expected size " + paramInt2 + " got " + paramInt1 + " (0x" + Integer.toHexString(paramInt1) + ")", paramParcel);
    }
  }
