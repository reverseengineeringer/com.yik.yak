    ...
    for (;;)
    {
      ...
      for (BackStackRecord.Op localOp = mHead; localOp != null; localOp = next)
      {
        ...
        if (fragment != null)
        {
          ...
          if (FragmentManagerImpl.DEBUG) {
            new StringBuilder().append("Bump nesting of ").append(fragment).append(" to ").append(fragment.mBackStackNesting).toString();
          }
        }
        if (removed != null)
        {
          ...
          while (i >= 0)
          {
            ...
            mBackStackNesting += paramInt;
            if (FragmentManagerImpl.DEBUG) {
              new StringBuilder().append("Bump nesting of ").append(localFragment).append(" to ").append(mBackStackNesting).toString();
            }
            i -= 1;
          }
        }
      ...
      for (;;)
      {
        ...
        if (mManager.mAdded != null)
        {
          ...
          if (n < mManager.mAdded.size())
          {
            ...
            if (FragmentManagerImpl.DEBUG) {
              new StringBuilder().append("OP_REPLACE: adding=").append(localObject1).append(" old=").append(localFragment).toString();
            }
            if (localObject1 != null)
            {
              localObject3 = localObject1;
