...
abstract class ModernAsyncTask<Params, Progress, Result>
{
  ...
  {
    sHandler.obtainMessage(1, new ModernAsyncTask.AsyncTaskResult(this, new Object[] { paramResult })).sendToTarget();
    return paramResult;
  }
  ...
  {
    if (!isCancelled()) {
      sHandler.obtainMessage(2, new ModernAsyncTask.AsyncTaskResult(this, paramVarArgs)).sendToTarget();
    }
  }
}
