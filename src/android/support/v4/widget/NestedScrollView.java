  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i != -1)
      {
        ...
        if (j == -1)
        {
          new StringBuilder().append("Invalid pointerId=").append(i).append(" in onInterceptTouchEvent").toString();
        }
        else
        {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      for (;;)
      {
        ...
        new StringBuilder().append("Invalid pointerId=").append(mActivePointerId).append(" in onTouchEvent").toString();
      }
