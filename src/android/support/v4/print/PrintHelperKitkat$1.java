  ...
  extends PrintDocumentAdapter
{
  ...
  public void onWrite(android.print.PageRange[] paramArrayOfPageRange, android.os.ParcelFileDescriptor paramParcelFileDescriptor, CancellationSignal paramCancellationSignal, android.print.PrintDocumentAdapter.WriteResultCallback paramWriteResultCallback)
  {
    ...
    //   137: aload 4
    //   139: aconst_null
    //   140: invokevirtual 167	android/print/PrintDocumentAdapter$WriteResultCallback:onWriteFailed	(Ljava/lang/CharSequence;)V
    //   143: goto -24 -> 119
    //   146: astore_3
    //   147: aload_1
    //   148: ifnull +7 -> 155
    //   151: aload_1
    //   152: invokevirtual 162	android/print/pdf/PrintedPdfDocument:close	()V
    //   155: aload_2
    //   156: ifnull +7 -> 163
    //   159: aload_2
    //   160: invokevirtual 163	android/os/ParcelFileDescriptor:close	()V
    //   163: aload_3
    //   164: athrow
    //   165: astore_1
    //   166: return
    ...
    //   0	171	0	this	1
    //   0	171	1	paramArrayOfPageRange	android.print.PageRange[]
    //   0	171	2	paramParcelFileDescriptor	android.os.ParcelFileDescriptor
    //   0	171	3	paramCancellationSignal	CancellationSignal
    //   0	171	4	paramWriteResultCallback	android.print.PrintDocumentAdapter.WriteResultCallback
