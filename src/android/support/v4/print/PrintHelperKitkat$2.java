  ...
  extends PrintDocumentAdapter
{
  ...
  public void onWrite(android.print.PageRange[] paramArrayOfPageRange, android.os.ParcelFileDescriptor paramParcelFileDescriptor, CancellationSignal paramCancellationSignal, android.print.PrintDocumentAdapter.WriteResultCallback paramWriteResultCallback)
  {
    ...
    //   137: aload 4
    //   139: aconst_null
    //   140: invokevirtual 221	android/print/PrintDocumentAdapter$WriteResultCallback:onWriteFailed	(Ljava/lang/CharSequence;)V
    //   143: goto -24 -> 119
    //   146: astore_3
    //   147: aload_1
    //   148: ifnull +7 -> 155
    //   151: aload_1
    //   152: invokevirtual 216	android/print/pdf/PrintedPdfDocument:close	()V
    //   155: aload_2
    //   156: ifnull +7 -> 163
    //   159: aload_2
    //   160: invokevirtual 217	android/os/ParcelFileDescriptor:close	()V
    //   163: aload_3
    //   164: athrow
    //   165: astore_1
    //   166: return
