  ...
  implements DecorToolbar
{
  ...
  {
    if (paramInt == 8) {
      ViewCompat.animate(mToolbar).alpha(0.0F).setListener(new ToolbarWidgetWrapper.2(this));
    }
    while (paramInt != 0) {
      return;
    }
    ViewCompat.animate(mToolbar).alpha(1.0F).setListener(new ToolbarWidgetWrapper.3(this));
  }
