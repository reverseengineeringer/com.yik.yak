  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  private void initGestureDetector()
  {
    ...
    mGestureDetector = new GestureDetectorCompat(mRecyclerView.getContext(), new ItemTouchHelper.ItemTouchHelperGestureListener(this, null));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return ItemTouchHelper.Callback.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return ItemTouchHelper.Callback.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(mRecyclerView));
    }
    return i;
  }
  ...
  public void startDrag(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    while (itemView.getParent() != mRecyclerView) {
      return;
    }
