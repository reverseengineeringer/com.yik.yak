  ...
  private boolean onTouchObserved(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      case 0: 
        ...
        mWasLongPress = false;
        if (mDisallowIntercept == null) {
          mDisallowIntercept = new ListPopupWindow.ForwardingListener.DisallowIntercept(this, null);
        }
        localView.postDelayed(mDisallowIntercept, mTapTimeout);
        if (mTriggerLongPress == null) {
          mTriggerLongPress = new ListPopupWindow.ForwardingListener.TriggerLongPress(this, null);
        }
