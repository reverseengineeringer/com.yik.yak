  ...
  implements CollapsibleActionView
{
  ...
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    mSearchSrcTextView = ((SearchView.SearchAutoComplete)findViewById(R.id.search_src_text));
    ...
    catch (RuntimeException paramString)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          new StringBuilder().append("Search suggestions cursor at row ").append(paramInt).append(" returned exception.").toString();
          return null;
        }
  ...
  private void updateQueryHint()
  {
    ...
    mSearchSrcTextView.setHint(getDecoratedHint(str));
    return;
