  ...
  extends ViewGroup
{
  ...
  {
    super(ViewUtils.themifyContext(paramContext, paramAttributeSet, false, true), paramAttributeSet, paramInt);
    ...
    mMinHeight = paramContext.getDimensionPixelSize(R.styleable.Toolbar_android_minHeight, 0);
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              if (bool)
              {
                ...
                mSubtitleTextView.layout(paramInt2 - k, paramInt1, paramInt2, m + paramInt1);
                ...
                for (paramInt1 = Math.min(paramInt4, paramInt1);; paramInt1 = paramInt2)
                {
                  ...
                  for (;;)
                  {
                    if (bool)
                    {
                      ...
                      m = mSubtitleTextView.getMeasuredHeight();
                      mSubtitleTextView.layout(paramInt3, paramInt4, paramInt1, m + paramInt4);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (shouldLayout(mTitleTextView))
      {
        ...
        k = ViewUtils.combineMeasuredStates(i, ViewCompat.getMeasuredState(mTitleTextView));
      }
      i3 = m;
      i2 = n;
      i = k;
      if (shouldLayout(mSubtitleTextView))
      {
        ...
        i = ViewUtils.combineMeasuredStates(k, ViewCompat.getMeasuredState(mSubtitleTextView));
      }
      j = Math.max(j, i3);
      n = getPaddingLeft();
      i3 = getPaddingRight();
