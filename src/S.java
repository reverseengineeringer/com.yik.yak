...
public class s
  implements View.OnKeyListener, ViewTreeObserver.OnGlobalLayoutListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener, u
{
  ...
  private v mPresenterCallback;
  private ViewTreeObserver mTreeObserver;
  
  public s(Context paramContext, MenuBuilder paramMenuBuilder)
  {
  ...
  private int measureContentWidth()
  {
    ...
    if (j < i2)
    {
      ...
      localView = localt.getView(j, localView, mMeasureParent);
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    t.a(paramAdapterView).a(paramAdapterView.a(paramInt), 0);
  }
  ...
  public boolean onSubMenuSelected(SubMenuBuilder paramSubMenuBuilder)
  {
    ...
    {
      locals = new s(mContext, paramSubMenuBuilder, mAnchorView);
      locals.setCallback(mPresenterCallback);
