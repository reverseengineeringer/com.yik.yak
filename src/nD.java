  ...
  implements nb
{
  ...
  /* Error */
  public hz a(android.graphics.Bitmap paramBitmap)
  {
    // Byte code:
    ...
    //   29: aload_0
    //   30: getfield 15	nd:a	Landroid/os/IBinder;
    //   33: bipush 6
    //   35: aload_2
    //   36: aload_3
    //   37: iconst_0
    ...
    //   52: invokestatic 47	hA:a	(Landroid/os/IBinder;)Lhz;
    //   55: astore_1
    //   56: aload_3
  ...
  public hz a(String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    try
    {
      ...
      localParcel2.readException();
      paramString = hA.a(localParcel2.readStrongBinder());
      return paramString;
    }
    finally
    {
  ...
  public hz c(String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    try
