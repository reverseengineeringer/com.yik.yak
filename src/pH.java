  ...
  implements nY
{
  ...
  {
    this(paramContext, iZ.c(), "google_tagmanager.db", 2000, Executors.newSingleThreadExecutor());
  }
  
  ph(Context paramContext, iY paramiY, String paramString, int paramInt, Executor paramExecutor)
  {
    c = paramContext;
    e = paramiY;
    f = paramInt;
    b = paramExecutor;
    d = new pk(this, c, paramString);
  }
  ...
  private List<nW> a(List<pl> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      pl localpl = (pl)paramList.next();
      localArrayList.add(new nW(a, a(b)));
    }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt > 0)
    {
      ...
      op.c("DataLayer store full, deleting " + localList.size() + " entries to make room.");
  ...
  private void a(long paramLong)
  {
    ...
    try
    {
      ...
      op.d("Deleted " + i + " expired items");
      return;
    }
    catch (SQLiteException localSQLiteException)
    {
      op.b("Error deleting old entries.");
    }
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    {
      op.b("Error deleting entries " + Arrays.toString(paramArrayOfString));
    }
  }
  ...
  private List<String> b(int paramInt)
  {
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 285
    //   16: invokestatic 88	op:b	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 287
    //   26: invokespecial 197	ph:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   182: invokestatic 88	op:b	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  private List<pl> b(List<nW> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      nW localnW = (nW)paramList.next();
      localArrayList.add(new pl(a, a(b)));
    }
    return localArrayList;
  }
  
  /* Error */
  private void b(List<pl> paramList, long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	ph:e	LiY;
    //   6: invokeinterface 274 1 0
    //   11: lstore 4
    //   13: aload_0
    //   14: lload 4
    //   16: invokespecial 276	ph:a	(J)V
    //   19: aload_0
    //   20: aload_1
    //   21: invokeinterface 173 1 0
    //   26: invokespecial 332	ph:a	(I)V
    //   29: aload_0
    //   30: aload_1
    //   31: lload 4
    //   33: lload_2
    //   34: ladd
    //   35: invokespecial 334	ph:c	(Ljava/util/List;J)V
    //   38: aload_0
    //   39: invokespecial 282	ph:e	()V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: astore_1
    //   46: aload_0
    //   47: invokespecial 282	ph:e	()V
    //   50: aload_1
    //   51: athrow
    //   52: astore_1
    //   53: aload_0
  ...
  private List<pl> c()
  {
    ...
    try
    {
      if (((Cursor)localObject).moveToNext()) {
        localArrayList.add(new pl(((Cursor)localObject).getString(0), ((Cursor)localObject).getBlob(1)));
      }
      return localList;
    }
    finally
  ...
  private void c(List<pl> paramList, long paramLong)
  {
  ...
  private int d()
  {
    ...
    for (;;)
    {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        op.b("Error getting numStoredEntries");
        return 0;
      }
      finally
      {
  ...
  public void a(List<nW> paramList, long paramLong)
  {
    paramList = b(paramList);
    b.execute(new pi(this, paramList, paramLong));
  }
  
  public void a(nZ paramnZ)
  {
    b.execute(new pj(this, paramnZ));
  }
}
