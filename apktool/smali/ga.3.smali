...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lga;->h:Ljava/lang/Object;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lga;->e:Landroid/content/Context;

    return-void
.end method

.method public static a(Landroid/content/Context;)LgR;
    .locals 2
    ...
    sget-object v1, Lga;->a:Ljava/lang/Object;
    ...
    invoke-direct {v0, p0}, Lga;-><init>(Landroid/content/Context;)V
...
.method private a(Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;)Z
    ...
    :cond_1
    iget-object v3, p0, Lga;->e:Landroid/content/Context;

    invoke-static {v3}, LgJ;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v3}, LgJ;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iget-object v5, p0, Lga;->h:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-boolean v6, p0, Lga;->g:Z

    if-nez v6, :cond_3

    iget-object v1, p0, Lga;->e:Landroid/content/Context;

    invoke-static {v1}, Lga;->b(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lga;->f:Ljava/lang/String;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lga;->g:Z
    ...
    invoke-static {v1}, Lga;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    :try_start_1
    iget-object v6, p0, Lga;->f:Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lga;->c(Ljava/lang/String;)Z
    ...
    :cond_7
    iget-object v1, p0, Lga;->f:Ljava/lang/String;
    ...
    invoke-virtual {v4}, LgJ;->b()Ljava/lang/String;
...
.method static b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lgo;->c(Ljava/lang/String;)Ljava/security/MessageDigest;
...
.method private c(Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-static {p1}, Lga;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lga;->e:Landroid/content/Context;
...
# virtual methods
.method a()Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;
    .locals 2
...
.method public a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lga;->a()Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;

    move-result-object v2

    iget-object v3, p0, Lga;->c:Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;

    invoke-direct {p0, v3, v2}, Lga;->a(Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;)Z

    move-result v3

    if-eqz v3, :cond_1

    iput-object v2, p0, Lga;->c:Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;

    :goto_0
    iput-wide v0, p0, Lga;->d:J

    :cond_0
    iget-object v0, p0, Lga;->c:Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;
