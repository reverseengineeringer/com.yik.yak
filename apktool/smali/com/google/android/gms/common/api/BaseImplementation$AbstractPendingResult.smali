...
# instance fields
.field private final Jp:Ljava/lang/Object;
...
.field private Jr:Lcom/google/android/gms/common/api/ResultCallback;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private volatile Js:Lcom/google/android/gms/common/api/Result;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "TR;"
        }
...
.field private final mr:Ljava/util/concurrent/CountDownLatch;
...
.method protected constructor <init>(Landroid/os/Looper;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jp:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->mr:Ljava/util/concurrent/CountDownLatch;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jq:Ljava/util/ArrayList;
...
.method protected constructor <init>(Lcom/google/android/gms/common/api/BaseImplementation$CallbackHandler;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static synthetic a(Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->gD()V
...
.method private c(Lcom/google/android/gms/common/api/Result;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Js:Lcom/google/android/gms/common/api/Result;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jr:Lcom/google/android/gms/common/api/ResultCallback;
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Ju:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->mHandler:Lcom/google/android/gms/common/api/BaseImplementation$CallbackHandler;

    iget-object v2, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jr:Lcom/google/android/gms/common/api/ResultCallback;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jq:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/common/api/PendingResult$a;->m(Lcom/google/android/gms/common/api/Status;)V
...
.method private gA()Lcom/google/android/gms/common/api/Result;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TR;"
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->gB()V
...
.method private gC()V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jv:Z
...
.method public final await()Lcom/google/android/gms/common/api/Result;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->gC()V
...
.method public final b(Lcom/google/android/gms/common/api/Result;)V
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jp:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-boolean v2, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jv:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Ju:Z
...
.method public abstract c(Lcom/google/android/gms/common/api/Status;)Lcom/google/android/gms/common/api/Result;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public cancel()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jr:Lcom/google/android/gms/common/api/ResultCallback;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Ju:Z

    sget-object v0, Lcom/google/android/gms/common/api/Status;->KA:Lcom/google/android/gms/common/api/Status;
...
.method protected gB()V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jt:Z

    iput-object v1, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Js:Lcom/google/android/gms/common/api/Result;

    iput-object v1, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jr:Lcom/google/android/gms/common/api/ResultCallback;
...
.method public final setResultCallback(Lcom/google/android/gms/common/api/ResultCallback;)V
    ...
    :cond_2
    :try_start_1
    iput-object p1, p0, Lcom/google/android/gms/common/api/BaseImplementation$AbstractPendingResult;->Jr:Lcom/google/android/gms/common/api/ResultCallback;
    :try_end_1
