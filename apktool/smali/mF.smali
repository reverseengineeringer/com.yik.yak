...
.method private static a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0}, LmF;->a(Ljava/lang/Class;)Ljava/lang/Object;
    :try_end_0
...
.method public static a(Landroid/content/Context;)Llw;
    ...
    :cond_0
    invoke-static {p0}, LmF;->b(Landroid/content/Context;)V

    invoke-static {p0}, LmF;->c(Landroid/content/Context;)Llw;

    move-result-object v0

    sput-object v0, LmF;->b:Llw;

    :try_start_0
    sget-object v0, LmF;->b:Llw;

    invoke-static {p0}, LmF;->d(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-interface {v0, v1, v2}, Llw;->a(Lhw;I)V
    :try_end_0
...
.method private static c(Landroid/content/Context;)Llw;
    .locals 2
    ...
    invoke-static {}, LmF;->b()Ljava/lang/Class;
    ...
    invoke-static {v0, v1}, LmF;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/os/IBinder;

    invoke-static {v0}, Llx;->a(Landroid/os/IBinder;)Llw;
...
.method private static d(Landroid/content/Context;)Landroid/content/Context;
    ...
    sget-object v0, LmF;->a:Landroid/content/Context;
    ...
    sput-object v0, LmF;->a:Landroid/content/Context;
