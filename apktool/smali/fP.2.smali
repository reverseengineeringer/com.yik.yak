...
.method public constructor <init>(Lcom/google/android/gms/analytics/Tracker;Ljava/lang/Thread$UncaughtExceptionHandler;Landroid/content/Context;)V
    ...
    :cond_1
    iput-object p2, p0, LfP;->a:Ljava/lang/Thread$UncaughtExceptionHandler;

    iput-object p1, p0, LfP;->b:Lcom/google/android/gms/analytics/Tracker;
    ...
    invoke-direct {v0, p3, v1}, LfX;-><init>(Landroid/content/Context;Ljava/util/Collection;)V

    iput-object v0, p0, LfP;->d:LfO;

    invoke-virtual {p3}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, LfP;->c:Landroid/content/Context;
...
.method public b()Ljava/lang/Thread$UncaughtExceptionHandler;
    ...
    iget-object v0, p0, LfP;->a:Ljava/lang/Thread$UncaughtExceptionHandler;
...
.method public uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v0, p2}, LfO;->a(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    iget-object v1, p0, LfP;->b:Lcom/google/android/gms/analytics/Tracker;

    new-instance v2, LfU;

    invoke-direct {v2}, LfU;-><init>()V

    invoke-virtual {v2, v0}, LfU;->a(Ljava/lang/String;)LfU;

    move-result-object v0

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, LfU;->a(Z)LfU;

    move-result-object v0

    invoke-virtual {v0}, LfU;->a()Ljava/util/Map;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/google/android/gms/analytics/Tracker;->send(Ljava/util/Map;)V

    invoke-virtual {p0}, LfP;->a()LfQ;
