...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lrz;->k:Ljava/util/Random;
...
.method public static a(Ljava/lang/String;Ljava/lang/String;[B)[B
    ...
    .line 36
    invoke-static {p0}, Lrz;->a(Ljava/lang/String;)[B

    move-result-object v0

    .line 37
    invoke-static {p1}, Lrz;->a(Ljava/lang/String;)[B
...
.method public a(LrK;)Ljava/nio/ByteBuffer;
    ...
    sget-object v1, LrL;->f:LrL;

    if-ne v0, v1, :cond_0

    .line 229
    sget-object v0, Lrz;->j:[B
    ...
    :cond_0
    invoke-super {p0, p1}, Lry;->a(LrK;)Ljava/nio/ByteBuffer;
...
.method public a(LrO;)LrO;
    ...
    invoke-static {}, Lrz;->e()Ljava/lang/String;
    ...
    invoke-interface {p1, v0}, LrO;->c(Ljava/lang/String;)Z
    ...
    iget-object v2, p0, Lrz;->k:Ljava/util/Random;
    ...
    .line 150
    iget-object v1, p0, Lrz;->k:Ljava/util/Random;

    invoke-virtual {v1, v0}, Ljava/util/Random;->nextBytes([B)V

    .line 151
    invoke-interface {p1, v0}, LrO;->a([B)V
...
.method public a(LrN;LrV;)LrP;
    ...
    invoke-interface {p1}, LrN;->a()Ljava/lang/String;
    ...
    .line 170
    :cond_1
    invoke-static {v0, v1, v2}, Lrz;->a(Ljava/lang/String;Ljava/lang/String;[B)[B

    move-result-object v0

    invoke-interface {p2, v0}, LrV;->a([B)V
...
.method public a(LrN;LrU;)Lru;
    ...
    invoke-virtual {p0, p2}, Lrz;->a(LrS;)Z
    ...
    throw v0
    :try_end_0
    .catch LrD; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p1, v2}, LrN;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3}, Lrz;->a(Ljava/lang/String;Ljava/lang/String;[B)[B
    ...
    sget-object v0, Lru;->b:Lru;
    :try_end_1
    .catch LrD; {:try_start_1 .. :try_end_1} :catch_0
...
.method public c(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 195
    invoke-super {p0, p1}, Lry;->e(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 198
    iget-object v0, p0, Lrz;->g:Ljava/util/List;

    .line 199
    const/4 v1, 0x1

    iput-boolean v1, p0, Lrz;->f:Z

    .line 200
    iget-object v1, p0, Lrz;->h:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, p0, Lrz;->h:Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lrz;->h:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, p0, Lrz;->g:Ljava/util/List;
...
.method public d(Ljava/nio/ByteBuffer;)LrS;
    ...
    .prologue
    .line 177
    iget-object v0, p0, Lrz;->d:Lrl;

    invoke-static {p1, v0}, Lrz;->a(Ljava/nio/ByteBuffer;Lrl;)LrP;
    ...
    invoke-interface {v1, v0}, LrP;->c(Ljava/lang/String;)Z
    ...
    .line 186
    invoke-interface {v1, v0}, LrP;->a([B)V
