...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lii;)V
    .locals 1
    ...
    iput-object v0, p0, Lig;->c:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lig;->a:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lig;->d:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lig;->e:Ljava/util/ArrayList;

    iput-object p3, p0, Lig;->b:Lii;

    new-instance v0, Lih;

    invoke-direct {v0, p0, p2}, Lih;-><init>(Lig;Landroid/os/Looper;)V

    iput-object v0, p0, Lig;->f:Landroid/os/Handler;

    return-void
.end method

.method static synthetic a(Lig;)Ljava/util/ArrayList;
    .locals 1

    iget-object v0, p0, Lig;->c:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic b(Lig;)Lii;
    .locals 1

    iget-object v0, p0, Lig;->b:Lii;
...
.method protected a()V
    ...
    iget-object v1, p0, Lig;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lig;->a(Landroid/os/Bundle;)V
...
.method public a(I)V
    ...
    iget-object v0, p0, Lig;->f:Landroid/os/Handler;
    ...
    iget-object v2, p0, Lig;->c:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lig;->b:Lii;

    invoke-interface {v3}, Lii;->gN()Z
    ...
    :cond_2
    iget-object v3, p0, Lig;->c:Ljava/util/ArrayList;
...
.method public a(Landroid/os/Bundle;)V
    ...
    :goto_0
    invoke-static {v2}, LiB;->a(Z)V

    iget-object v2, p0, Lig;->f:Landroid/os/Handler;
    ...
    iput-boolean v2, p0, Lig;->d:Z

    iget-object v2, p0, Lig;->a:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lig;->b:Lii;

    invoke-interface {v2}, Lii;->gN()Z
    ...
    invoke-interface {v2}, Lii;->isConnected()Z
    ...
    :cond_1
    iget-object v0, p0, Lig;->a:Ljava/util/ArrayList;
...
.method public a(Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    iget-object v1, p0, Lig;->e:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lig;->e:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v3, p0, Lig;->e:Ljava/util/ArrayList;
...
.method public a(Lcom/google/android/gms/common/GooglePlayServicesClient$OnConnectionFailedListener;)V
    ...
    :try_start_0
    iget-object v0, p0, Lig;->e:Ljava/util/ArrayList;
...
.method public a(Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;)V
    ...
    iget-object v1, p0, Lig;->f:Landroid/os/Handler;
