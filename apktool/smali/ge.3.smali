...
.method constructor <init>(Lgs;Landroid/content/Context;LgM;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lge;-><init>(Lgs;Landroid/content/Context;Ljava/lang/String;ILgM;)V

    return-void
.end method

.method constructor <init>(Lgs;Landroid/content/Context;Ljava/lang/String;ILgM;)V
    .locals 4
    ...
    iput-object v0, p0, Lge;->e:Landroid/content/Context;

    iput-object p5, p0, Lge;->k:LgM;

    iput-object p3, p0, Lge;->f:Ljava/lang/String;

    iput-object p1, p0, Lge;->d:Lgs;

    invoke-static {}, LiW;->c()LiV;

    move-result-object v0

    iput-object v0, p0, Lge;->j:LiV;

    new-instance v0, Lgf;

    iget-object v1, p0, Lge;->e:Landroid/content/Context;

    iget-object v2, p0, Lge;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Lgf;-><init>(Lge;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lge;->b:Lgf;
    ...
    iget-object v2, p0, Lge;->e:Landroid/content/Context;

    iget-object v3, p0, Lge;->k:LgM;

    invoke-direct {v0, v1, v2, v3}, Lgy;-><init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;LgM;)V

    iput-object v0, p0, Lge;->c:LgP;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lge;->h:J
...
.method private a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v0}, Lgf;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    invoke-static {p1}, Lgc;->d(Ljava/lang/String;)V
...
.method static synthetic a(Lge;)LiV;
    .locals 1

    iget-object v0, p0, Lge;->j:LiV;
...
.method static a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lga;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lga;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Ljava/util/Map;JLjava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lge;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {p1}, Lge;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lge;->d:Lgs;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Lgs;->a(Z)V
    :try_end_1
...
.method static synthetic b(Lge;)Ljava/lang/String;
    .locals 1
...
.method static synthetic c(Lge;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lge;->e:Landroid/content/Context;
...
.method private f()V
    ...
    invoke-virtual {p0, v0}, Lge;->a(I)Ljava/util/List;
...
.method a()I
    ...
    iget-object v2, p0, Lge;->j:LiV;

    invoke-interface {v2}, LiV;->a()J

    move-result-wide v2

    iget-wide v4, p0, Lge;->h:J
    ...
    :cond_1
    iput-wide v2, p0, Lge;->h:J

    const-string v2, "Error opening database for deleteStaleHits."

    invoke-direct {p0, v2}, Lge;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v2

    if-eqz v2, :cond_0

    iget-object v3, p0, Lge;->j:LiV;

    invoke-interface {v3}, LiV;->a()J
    ...
    :goto_1
    invoke-interface {v3, v0}, Lgs;->a(Z)V
...
.method public a(J)V
    ...
    :goto_1
    invoke-interface {v2, v0}, Lgs;->a(Z)V
...
.method a(Ljava/util/Collection;)V
    ...
    :cond_2
    invoke-virtual {p0, v3}, Lge;->a([Ljava/lang/String;)V
...
.method public a(Ljava/util/Map;JLjava/lang/String;Ljava/util/Collection;)V
    ...
    invoke-virtual {p0}, Lge;->a()I

    invoke-direct {p0}, Lge;->f()V

    invoke-direct {p0, p1, p5}, Lge;->a(Ljava/util/Map;Ljava/util/Collection;)V

    invoke-direct {p0, p1, p2, p3, p4}, Lge;->a(Ljava/util/Map;JLjava/lang/String;)V
...
.method public a(Z)V
    ...
    iget-object v0, p0, Lge;->c:LgP;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lge;->c:LgP;

    invoke-interface {v0, p1}, LgP;->a(Z)V
...
.method public b(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Lge;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v4 .. v10}, LfZ;-><init>(Ljava/lang/String;JJLjava/lang/String;)V
    ...
    invoke-virtual {v2, v5}, LfZ;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v5}, LfZ;->b(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lgc;->d(Ljava/lang/String;)V
    :try_end_5
...
.method public c()V
    ...
    iget-object v2, p0, Lge;->c:LgP;

    invoke-interface {v2}, LgP;->a()Z
    ...
    invoke-virtual {p0, v2}, Lge;->b(I)Ljava/util/List;
    ...
    iget-object v1, p0, Lge;->d:Lgs;

    invoke-interface {v1, v0}, Lgs;->a(Z)V

    goto :goto_0

    :cond_1
    iget-object v3, p0, Lge;->g:Lgd;
    ...
    invoke-direct {v3, v4, v1}, Lgd;-><init>(Ljava/lang/String;Z)V

    iput-object v3, p0, Lge;->g:Lgd;
    ...
    :goto_1
    iget-object v3, p0, Lge;->c:LgP;

    iget-object v4, p0, Lge;->g:Lgd;

    invoke-interface {v3, v2, v4, v0}, LgP;->a(Ljava/util/List;Lgd;Z)I
    ...
    invoke-static {v3}, Lgc;->c(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lge;->a(Ljava/util/Collection;)V
